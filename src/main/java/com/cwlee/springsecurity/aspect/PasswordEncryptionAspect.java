package com.cwlee.springsecurity.aspect;

import com.cwlee.springsecurity.annotation.CustomeEncryption;
...
public class PasswordEncryptionAspect {
    ...
    @Around("execution(* com.cwlee.springsecurity.controller..*.*(..))")
    ...
    public void fieldEncryption(Object object) {
        ...
        FieldUtils.getAllFieldsList(object.getClass())
                ...
                .forEach(field -> {
                    try {
                        boolean encryptionTarget = field.isAnnotationPresent(CustomeEncryption.class);
                        if(!encryptionTarget) {
                            return;
                        }
